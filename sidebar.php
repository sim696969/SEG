...
<nav id="sidebar">
    ...
    <ul class="nav-links">
        ...
        <li class="<?php echo ($current_page == 'student_dashboard.php') ? 'active' : ''; ?>">
            <a href="student_dashboard.php">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"><path d="M160-120v-480h160v480H160Zm240 0v-200h160v200H400Zm240 0v-360h160v360H640ZM80-80v-640q0-33 23.5-56.5T160-760h640q33 0 56.5 23.5T880-680v640q0 33-23.5 56.5T800-0H160q-33 0-56.5-23.5T80-80Z"/></svg>
                <span>Dashboard</span>
            </a>
        </li>
        ...
        <!-- This is the new conditional link for the admin panel -->
